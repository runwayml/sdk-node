import fs from 'fs';
import type { ResponseLike } from '@runwayml/sdk/internal/to-file';
import { toFile } from '@runwayml/sdk/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@runwayml/sdk/core/uploads');
    await expect(
